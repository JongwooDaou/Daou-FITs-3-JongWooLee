...
## Problem:
- 객체지향을 위한 자바의 기본기 습득 필요

## Solution:
- 상속, 구현, 인터페이스의 실습을 통한 연습과 코드작성
...
public interface MyInterface {
    ...
    //field
    //public static final k =100 이지만 생략됨
    int k = 100;
    ...
    public int myData(int k);
}

// interface는 구현을 통해 사용
...
public class MyObjectClass {
    ...
    public boolean equals(Object o) {
        MyObjectClass that = (MyObjectClass) o;
